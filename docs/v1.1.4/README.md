# ngx-otp-input (v1.1.4)

[![License](https://img.shields.io/github/license/pkovzz/ngx-otp-input?style=flat)](../../LICENSE)

This is an archived copy of the v1.1.4 documentation for the legacy API.
For the latest docs, see the repository root `README.md`.

> Source snapshot: `git show v1.1.4:README.md`
...
Please read the [CODE_OF_CONDUCT](../../CODE_OF_CONDUCT.md) file for more information.
